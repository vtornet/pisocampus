...
const { users, advertisers, listings, universities } = require('../src/lib/db/schema')
...
async function seed() {
  ...
  const listingsData = [
    ...
    {
      id: 'list_3',
      title: 'Piso compartido en Lavapiés',
      description: 'Habitación doble en piso céntrico, zona muy animada con restaurantes y ocio.',
      type: 'room',
      advertiserId: advertiserId,
      universityId: 'uc3m',
      city: 'Madrid',
      ...
      area: 14,
      furnished: true,
      features: { wifi: true, heating: true },
